...
Round 2: extends the round-1 sweep (10, 50, 100, 500 -- all held-out
collapsed, but lambda=500 was the best point on every axis and still
trending in the right direction) to a higher-lambda grid to see whether the
held-out Pareto bar is reachable by pushing further in the same direction.
"""
