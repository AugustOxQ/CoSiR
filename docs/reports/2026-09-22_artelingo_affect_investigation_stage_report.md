...
The net conclusion is that buddy graph alone will not deliver PercepT-style affect interpretability. Under realistic, unsupervised, RedCaps-compatible conditions, the evidence supports accepting a much more modest approximately 15–17% AMI ceiling, or making a genuine architectural or data change, such as targeting a labeled dataset or building a supervised affect branch. Both options go beyond what buddy-graph initialization was designed to do.
